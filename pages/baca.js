document.addEventListener('DOMContentLoaded', async () => {
    ...
    function parseTextToTokens() {
        ...
        for (let l = 0; l < lines.length; l++) {
            ...
            let isTitle = ['SUBUH', 'DZUHUR', 'ASHAR', 'MAGRIB', 'ISYA', 'SAJAK UNTUKMU', 'SENYUMMU', 'HARI INI'].includes(trimmed);
    ...
    function measurePages() {
        ...
        scene.style.transform = 'none'; // Disable 3D to fix scrollHeight bug
        ...
        scene.style.transform = ''; // Restore 3D
    }
